with prod as (
    ...
    select ord.order_date, ord.order_id, cs.company_name customer, em.name employee, em.age, em.lenght_of_service
    ...
    select od.*, ord.order_date, ord.customer, ord.employee, ord.age, ord.lenght_of_service
    from orddetai od
